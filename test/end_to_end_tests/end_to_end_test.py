...
def test_success(test_name: str, monkeypatch: pytest.MonkeyPatch, tmp_path: pathlib.Path):
...
def test_failure(test_name: str, monkeypatch: pytest.MonkeyPatch, tmp_path: pathlib.Path):
